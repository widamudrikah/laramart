        ...
        @endif
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    <div class="col-md-6 my-auto">
                                        <a href="{{ route('products-view', ['category_slug' => $cartItem->product->category->slug, 'product_slug' => $cartItem->product->slug]) }}">
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">@rupiah($cartItem->product->selling_price)</label>
                                        @php 
                                    ...
                                    <div class="col-md-1 my-auto">
                                        <label class="price">@rupiah($cartItem->product->selling_price * $cartItem->quantity)</label>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        Get the best Deals and Offers <a href="{{ route('categories') }}">shop now</a>
                    </h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4>Total :
                            <span class="float-end">@rupiah($totalPrice)</span>
                        </h4>
                        <hr>
